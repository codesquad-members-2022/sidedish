...
class ThirdSectionViewController: UIViewController{
    private var thirdSection = UIView(frame: CGRect(x: 0, y: 0, width: 343, height: 225))
...
private extension ThirdSectionViewController{
    func configureCountLabel(){
        ...
        self.thirdSection.addSubview(countLabel)
        
        countLabel.translatesAutoresizingMaskIntoConstraints = false
        countLabel.topAnchor.constraint(equalTo: self.thirdSection.bottomAnchor, constant: 26).isActive = true
        countLabel.leadingAnchor.constraint(equalTo: self.thirdSection.leadingAnchor).isActive = true
    ...
    func configureCountText(){
        ...
        self.thirdSection.addSubview(countText)
        
        countText.translatesAutoresizingMaskIntoConstraints = false
        countText.topAnchor.constraint(equalTo: self.thirdSection.bottomAnchor, constant: 26).isActive = true
        countText.leadingAnchor.constraint(equalTo: self.countLabel.trailingAnchor, constant: 150).isActive = true
        countText.widthAnchor.constraint(equalToConstant: 24).isActive = true
        countText.heightAnchor.constraint(equalToConstant: 9).isActive = true
    }
    ...
    func configureCountStepper(){
        ...
        self.thirdSection.addSubview(countStepper)
        
        countStepper.translatesAutoresizingMaskIntoConstraints = false
        countStepper.topAnchor.constraint(equalTo: self.thirdSection.bottomAnchor, constant: 26).isActive = true
        countStepper.leadingAnchor.constraint(equalTo: self.countText.trailingAnchor, constant: 24).isActive = true
        countStepper.trailingAnchor.constraint(equalTo: self.thirdSection.trailingAnchor).isActive = true
    ...
    func configureSectionBottom(){
        ...
        self.thirdSection.addSubview(sectionBottom)
        ...
        sectionBottom.leadingAnchor.constraint(equalTo: self.thirdSection.leadingAnchor).isActive = true
        sectionBottom.trailingAnchor.constraint(equalTo: self.thirdSection.trailingAnchor).isActive = true
