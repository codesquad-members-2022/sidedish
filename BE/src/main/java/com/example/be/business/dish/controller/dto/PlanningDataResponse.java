...
public class PlanningDataResponse {
    ...
    public PlanningDataResponse(Long dishId, String name, String description, BigDecimal normalPrice, Badge badge, DeliveryPriceOption deliveryPriceOption, String thumbnail, DishStatus dishStatus, String title) {
        this.dishId = dishId;
        this.name = name;
