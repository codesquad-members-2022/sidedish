...
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, dawn_delivery_flag, whole_nation_delivery_flag, price, discount_type, discount_rate, created_datetime, modified_datetime) VALUES (1, 3, '오리 주물럭_반조리', '감칠맛 나는 매콤한 양념', true, true, 15800, '런칭특가', 20, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, discount_type, discount_rate, created_datetime, modified_datetime) VALUES (1, 3, '소갈비찜', '촉촉하게 벤 양념이 일품', 28900, '이벤트특가', 10, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, discount_rate, created_datetime, modified_datetime) VALUES (1, 3, '쭈꾸미 한돈 제육볶음_반조리', '쫄깃한 쭈구미와 고소한 돼지고기가 일품', 16900, 0, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, discount_rate, created_datetime, modified_datetime) VALUES (1, 3, '돼지불갈비', '맛있어요!!', 10000, 0, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, dawn_delivery_flag, whole_nation_delivery_flag, price, discount_type, discount_rate, created_datetime, modified_datetime) VALUES (2, 1, '연근조림', '맛있어요!!', true, true, 2000, '런칭특가', 20, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, discount_type, discount_rate, created_datetime, modified_datetime) VALUES (2, 1, '오징어채', '맛있어요!!', 3000, '이벤트특가', 10, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, discount_rate, created_datetime, modified_datetime) VALUES (2, 1, '배추김치', '맛있어요!!', 4000, 0, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, discount_rate, created_datetime, modified_datetime) VALUES (2, 1, '장조림', '맛있어요!!', 5000, 0, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, dawn_delivery_flag, whole_nation_delivery_flag, price, discount_type, discount_rate, created_datetime, modified_datetime) VALUES (3, 2, '냉면', '맛있어요!!', true, true, 8000, '런칭특가', 20, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, discount_type, discount_rate, created_datetime, modified_datetime) VALUES (3, 1, '죽순볶음', '맛있어요!!', 9000, '이벤트특가', 10, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, discount_rate, created_datetime, modified_datetime) VALUES (3, 3, '연어구이', '맛있어요!!', 10000, 0, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, discount_rate, created_datetime, modified_datetime) VALUES (3, 3, '광어구이', '맛있어요!!', 11000, 0, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, dawn_delivery_flag, whole_nation_delivery_flag, price, discount_type, discount_rate, created_datetime, modified_datetime) VALUES (4, 1, '김', '맛있어요!!', true, true, 1000, '런칭특가', 20, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, discount_type, discount_rate, created_datetime, modified_datetime) VALUES (4, 1, '콩자반', '맛있어요!!', 2000, '이벤트특가', 10, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, discount_rate, created_datetime, modified_datetime) VALUES (4, 1, '호두멸치볶음', '맛있어요!!', 3000, 0, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, discount_rate, created_datetime, modified_datetime) VALUES (4, 1, '시금치 무침', '맛있어요!!', 4000, 0, NOW(), NOW());
