...
INSERT INTO sidedish (event_category_id, menu_category_id, discount_policy_id, name, description, dawn_delivery_flag, whole_nation_delivery_flag, price, created_datetime, modified_datetime) VALUES (1, 3, 1, '오리 주물럭_반조리', '감칠맛 나는 매콤한 양념', true, true, 15800, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, discount_policy_id, name, description, price, created_datetime, modified_datetime) VALUES (1, 3, 2, '소갈비찜', '촉촉하게 벤 양념이 일품', 28900, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, created_datetime, modified_datetime) VALUES (1, 3, '쭈꾸미 한돈 제육볶음_반조리', '쫄깃한 쭈구미와 고소한 돼지고기가 일품', 16900, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, created_datetime, modified_datetime) VALUES (1, 3, '돼지불갈비', '맛있어요!!', 10000, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, discount_policy_id, name, description, dawn_delivery_flag, whole_nation_delivery_flag, price, created_datetime, modified_datetime) VALUES (2, 1, 1, '연근조림', '맛있어요!!', true, true, 2000, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, discount_policy_id, name, description, price, created_datetime, modified_datetime) VALUES (2, 1, 2, '오징어채', '맛있어요!!', 3000, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, created_datetime, modified_datetime) VALUES (2, 1, '배추김치', '맛있어요!!', 4000, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, created_datetime, modified_datetime) VALUES (2, 1, '장조림', '맛있어요!!', 5000, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, discount_policy_id, name, description, dawn_delivery_flag, whole_nation_delivery_flag, price, created_datetime, modified_datetime) VALUES (3, 2, 1, '냉면', '맛있어요!!', true, true, 8000, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, discount_policy_id, name, description, price, created_datetime, modified_datetime) VALUES (3, 1, 2, '죽순볶음', '맛있어요!!', 9000, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, created_datetime, modified_datetime) VALUES (3, 3, '연어구이', '맛있어요!!', 10000, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, created_datetime, modified_datetime) VALUES (3, 3, '광어구이', '맛있어요!!', 11000, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, discount_policy_id, name, description, dawn_delivery_flag, whole_nation_delivery_flag, price, created_datetime, modified_datetime) VALUES (4, 1, 1, '김', '맛있어요!!', true, true, 1000, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, discount_policy_id, name, description, price, created_datetime, modified_datetime) VALUES (4, 1, 2, '콩자반', '맛있어요!!', 2000, NOW(), NOW());
INSERT INTO sidedish (event_category_id, menu_category_id, name, description, price, created_datetime, modified_datetime) VALUES (4, 1, '호두멸치볶음', '맛있어요!!', 3000, NOW(), NOW());
