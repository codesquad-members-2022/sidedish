...
public class DishSaveRequest {
    ...
    public DishSaveRequest(String name, String description, BigDecimal normalPrice, BigDecimal salePrice, Badge badge, DeliveryType deliveryType, String thumbnail, DishStatus dishStatus, Long categoryId) {
        this.name = name;
    ...
    public Dish toEntity() {
        return new Dish(name, description, normalPrice, badge, deliveryType, thumbnail, dishStatus, categoryId);
    }
