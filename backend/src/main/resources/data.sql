...
(1, '오리 주물럭_반조리', '감칠맛 나는 매콤한 양념', 15800, 10, "https://leejohy-springboot-build.s3.ap-northeast-2.amazonaws.com/2cdf7235b65a114abff05b9133f90085.jpeg", "런칭특가", 20);

INSERT INTO item (CATEGORY_ID, NAME, DESCRIPTION, PRICE, STOCK, MAIN_IMAGE_LINK, DISCOUNT_POLICY, DISCOUNT_RATE) values
(1, '잡채', '탱글한 면발과 맛깔진 고명이 가득', 12900, 10, "https://leejohy-springboot-build.s3.ap-northeast-2.amazonaws.com/2cdf7235b65a114abff05b9133f90085.jpeg", "이벤트특가", 10);
...
--카테고리 2
INSERT INTO item (CATEGORY_ID, NAME, DESCRIPTION, PRICE, STOCK, MAIN_IMAGE_LINK, DISCOUNT_POLICY, DISCOUNT_RATE) values
(2, '한돈 돼지김치찌개', '김치찌개에는 역시 돼지고기', 9300, 10, "https://leejohy-springboot-build.s3.ap-northeast-2.amazonaws.com/2cdf7235b65a114abff05b9133f90085.jpeg", "이벤트특가", 10);

INSERT INTO item (CATEGORY_ID, NAME, DESCRIPTION, PRICE, STOCK, MAIN_IMAGE_LINK, DISCOUNT_POLICY, DISCOUNT_RATE) values
(2, '된장찌개', '특별하지 않아서 더 좋은 우리맛', 8800, 10, "https://leejohy-springboot-build.s3.ap-northeast-2.amazonaws.com/2cdf7235b65a114abff05b9133f90085.jpeg", "이벤트특가", 10);
