...
public class CategoryController {
    ...
    @GetMapping("/{type}")
    public CollectionModel<ItemResource> getItemsByCategory(@PathVariable CategoryType type, @RequestParam(defaultValue = "1") Long pageId, @RequestParam(defaultValue = "4") int pageCount) {
