...
INSERT INTO item (category_id, item_name, description, origianl_price, discount_price, stock, label_id, main_image,
                  delivery_id, best_id)
...
VALUES (1,'호두 멸치볶음','잔멸치와 호두가 만나 짭쪼롬하지만 고소하지',5800,5220,10,2,
        '',
        2,2);
INSERT INTO item (category_id, item_name, description, origianl_price, stock, label_id, main_image,
                  delivery_id, best_id)
