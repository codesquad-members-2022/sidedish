...
insert into image(name, dish_id, dish_key) values ('짱민아침메인사진.jpg', 1L, 1);
insert into image(name, dish_id, dish_key) values ('짱민아침서브사진.jpg', 1L, 2);
insert into image(name, dish_id, dish_key) values ('짱민아침디테일사진.jpg', 1L, 3);
insert into image(name, dish_id, dish_key) values ('짱민점심메인사진.jpg', 2L, 1);
