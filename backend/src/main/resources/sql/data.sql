...
-- festival
INSERT INTO dish (event_badge_id, title, description, price)
VALUES (1, '오리 주물럭_반조리', '감칠맛 나는 매콤한 양념', 15800);
INSERT INTO dish (event_badge_id, title, description, price)
VALUES (2, '소갈비찜', '촉촉하게 밴 양념이 일품', 28900);
INSERT INTO dish (event_badge_id, title, description, price)
VALUES (NULL, '쭈꾸미 한돈 제육볶음_반조리', '쫄깃한 쭈꾸미와 고소한 돼지고기가 일품', 16900);

-- side
INSERT INTO dish (event_badge_id, title, description, price)
VALUES (1, '새콤달콤 오징어무침', '국내산 오징어를 새콤달콤하게', 7500);
INSERT INTO dish (event_badge_id, title, description, price)
VALUES (2, '호두 멸치볶음', '잔멸치와 호두가 만나 짭조름하지만 고소하게!', 5800);
INSERT INTO dish (event_badge_id, title, description, price)
VALUES (2, '한돈 매콤 안심장조림', '부드러운 한돈 안심살의 매콤함', 6900);
INSERT INTO dish (event_badge_id, title, description, price)
VALUES (2, '야채 어묵볶음', '첨가물 없는 순수어묵과 야채의 만남', 4900);
INSERT INTO dish (event_badge_id, title, description, price)
VALUES (2, '오이소박이', NULL, 7300);
INSERT INTO dish (event_badge_id, title, description, price)
VALUES (NULL, '미나리무침', NULL, 4300);
INSERT INTO dish (event_badge_id, title, description, price)
VALUES (NULL, '참외오이무침', NULL, 4300);

-- soup
INSERT INTO dish (event_badge_id, title, description, price)
VALUES (2, '한돈 돼지 김치찌개', '김치찌개에는 역시 돼지고기', 9300);
INSERT INTO dish (event_badge_id, title, description, price)
VALUES (2, '된장찌개', '특별하지 않아서 더 좋은 우리맛', 8800);
INSERT INTO dish (event_badge_id, title, description, price)
VALUES (2, '미역오이냉국', '여름엔 시원한 냉국이 최고', 7500);
INSERT INTO dish (event_badge_id, title, description, price)
VALUES (NULL, '동태찌개', '겨울철 보양식으로 안성맞춤', 10900);

-- main
INSERT INTO dish (event_badge_id, title, description, price)
VALUES (2, '잡채', '탱글한 면과 맛깔진 고명이 가득', 12900);
INSERT INTO dish (event_badge_id, title, description, price)
VALUES (NULL, '간장 코다리조림', '쫀득한 코디를 국내산 간장소스로 맛있게 조렸어요', 14900);
