...
INSERT INTO category (category_name) VALUE ('sidedish');
INSERT INTO category (category_name) VALUE ('soup');
INSERT INTO category (category_name) VALUE ('main');
INSERT INTO label (label_name) VALUE ('런칭특가');
INSERT INTO label (label_name) VALUE ('이벤트특가');
INSERT INTO label (label_name) VALUE ('라벨없음');
INSERT INTO delivery (delivery_name) VALUE ('새벽배송');
INSERT INTO delivery (delivery_name) VALUE ('전국배송');
INSERT INTO delivery (delivery_name) VALUE ('새벽배송/전국배송');
INSERT INTO best_type (best_name) VALUE ('meat');
INSERT INTO best_type (best_name) VALUE ('simple');
INSERT INTO best_type (best_name) VALUE ('seasonal');
INSERT INTO best_type (best_name) VALUE ('nutrition');
