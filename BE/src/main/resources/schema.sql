...
DROP TABLE IF EXISTS sidedish_price;
...
(
    ...
    name VARCHAR(32),
    progress_flag TINYINT(1) NOT NULL DEFAULT 0 COMMENT '이벤트 진행 유무 : 진행 안함 0, 진행 중 1',
    PRIMARY KEY (id)
);
...
(
    ...
    dawn_delivery_flag         TINYINT(1) NOT NULL DEFAULT 0 COMMENT '새벽배송 가능 유무 : 불가 0, 가능 : 1',
    whole_nation_delivery_flag TINYINT(1) NOT NULL DEFAULT 0 COMMENT '전국 택배 가능 유무 : 불가 0, 가능 : 1',
...
(
    ...
    delete_flag       TINYINT(1) NOT NULL DEFAULT 0 COMMENT '삭제 유무 : 존재 0, 삭제 : 1',
    created_datetime  TIMESTAMP,
    modified_datetime TIMESTAMP,
    PRIMARY KEY (id),
    FOREIGN KEY (sidedish_id) REFERENCES sidedish (id)
