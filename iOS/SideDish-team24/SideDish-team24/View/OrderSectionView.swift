...
class OrderSectionView: UIView {
    ...
    private let totalAmountTitleLabel: UILabel = UILabel.customLabel("총 주문금액", .lightGray, 18, 600)
    private let totalAmountLabel: UILabel = UILabel.customLabel("12,640원", .dishBlack, 32, 600)
