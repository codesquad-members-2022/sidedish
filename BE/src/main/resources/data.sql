...
insert into item (name, description, price, discount_policy_id, item_section_id, stock)
values ('땃쥐고기', '땃쥐고기입니다.', 10000, 1, 1, 100),
       ('리고기', '리고기입니다.', 20000, 2, 1, 100),
       ('순대국밥', '따끈한 국밥입니다.', 20000, 1, 2, 100),
       ('김치', '없이는 못 삽니다.', 20000, 1, 3, 100);
